...
cartApp.post(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    let productOfDB = await cartCollectionObject.findOne({
      book: cartObj.book,
...
cartApp.get(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    let cartCollectionObject = request.app.get("cartCollectionObject");
    //read all products
    let products = await cartCollectionObject
      .find({ username: request.params.name })
      .toArray(); //converts the cursors to array
...
cartApp.put(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    //update the user
    await cartCollectionObject.updateOne(
      { username: modifiedItem.username, book: modifiedItem.book },
      { $set: { ...modifiedItem } }
    );
    //send response
...
cartApp.delete(
  ...
  expressAsyncHandler(async (request, response) => {
    ...
    //delete the product
    await cartCollectionObject.deleteOne({
